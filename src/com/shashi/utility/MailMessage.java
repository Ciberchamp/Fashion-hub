...
public class MailMessage {
	public static void registrationSuccess(String emailId, String name) {
		...
		String htmlTextMessage = "" +  "<html>" +
                "<body>" +
                "<h2 style='color:blue;'>Welcome to Versa Laurent Fashion Store</h2>" +
                "Hi " + name + "," +
                "<br><br>Thank you for signing up with Versa Laurent! We're thrilled to have you on board.<br>" +
                "Explore our latest collection of stylish clothing and accessories designed just for you! " +
                "<br>As a special welcome gift, we're offering you an exclusive 15% OFF on your first purchase.<br>" +
                "To redeem this offer, simply use the promo code below at checkout:<br><br>" +
                "<strong>PROMO CODE: VERSA15</strong><br><br>" +
                "Don't miss out on our trendy fashion pieces that are perfect for any occasion! " +
                "<br>Visit our website now and find your new favorite outfit.<br><br>" +
                "We're here to provide you with the best shopping experience, so feel free to reach out if you have any questions.<br>" +
	...
	public static void transactionSuccess(String recipientEmail, String name, String transId, double transAmount) {
		...
		String subject = "Order Placed at Versa Laurent";
		String htmlTextMessage = "<html>" + "  <body>" + "    <p>" + "      Hey " + name + ",<br/><br/>"
				+ "      We are glad that you shop with Versa Laurent!" + "      <br/><br/>"
				...
				+ "      Come Shop Again! <br/<br/> <font style=\"color:green;font-weight:bold;\">Versa Laurent.</font>"
				+ "    </p>" + "    " + "  </body>" + "</html>";
	...
	public static void orderShipped(String recipientEmail, String name, String transId, double transAmount) {
		String recipient = recipientEmail;
		String subject = "Hurray!!, Your Order has been Shipped from Versa Laurent";
		String htmlTextMessage = "<html>" + "  <body>" + "    <p>" + "      Hey " + name + ",<br/><br/>"
				+ "      We are glad that you shop with Versa Laurent!" + "      <br/><br/>"
	...
	public static void productAvailableNow(String recipientEmail, String name, String prodName, String prodId) {
		String recipient = recipientEmail;
		String subject = "Product " + prodName + " is Now Available at Versa Laurent";
		String htmlTextMessage = "<html>" + "  <body>" + "    <p>" + "      Hey " + name + ",<br/><br/>"
				+ "      We are glad that you shop with Versa Laurent!" + "      <br/><br/>"
				...
				+ "      Come Shop Again! <br/<br/><br/> <font style=\"color:green;font-weight:bold;\">Versa Laurent.</font>"
				+ "    </p>" + "    " + "  </body>" + "</html>";
