...
<body style="background-color: pink !important;">
	...
	<div class="container-fluid text-center"
		style="margin-top: 45px; background-color:  #454545; color: white; padding: 5px;">
		<h2>VERSA LAURENT</h2>
		<h6>The iconic style center</h6>
		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.jsp"><span
					class="glyphicon glyphicon-home">&nbsp;</span>Fashion hub</a>
			</div>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="index.jsp?type=European">European</a></li>
							<li><a href="index.jsp?type=Arabic">Arabic</a></li>
							<li><a href="index.jsp?type=Indian">Indian</a></li>
							<li><a href="index.jsp?type=Crystal">Crystal</a></li>
							<li><a href="index.jsp?type=Accessories">Accessories</a></li>
							<li><a href="index.jsp?type=Beauty">Beauty</a></li>
						</ul></li>
				</ul>
			</div>
		</div>
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="userHome.jsp?type=European">European</a></li>
							<li><a href="userHome.jsp?type=Arabic">Arabic</a></li>
							<li><a href="userHome.jsp?type=Indian">Indian</a></li>
							<li><a href="userHome.jsp?type=Crystal">Crystal</a></li>
							<li><a href="userHome.jsp?type=Accessories">Accessories</a></li>
							<li><a href="userHome.jsp?type=Beauty">Beauty</a></li>
						</ul></li>
					<%
					if (notf == 0) {
					%>
